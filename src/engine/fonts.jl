...
# Optional fields
  ...
  - `enable_ssty`: Whether or not to use the "ssty" feature for special super or subscript 
    glpdhs, if available in an OpenType font.\n
    Defaults to `MathTeXEngine._default_enable_ssty`.
